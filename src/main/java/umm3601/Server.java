...
public class Server {
  ...
  private static umm3601.todo.TodoDatabase todoDatabase;
  ...
  private static UserController buildUserController() {
    ...
    try {
      userDatabase = new umm3601.user.Database(USER_DATA_FILE);
  ...
  private static TodoController buildTodoController() {
    ...
    try {
      todoDatabase = new umm3601.todo.TodoDatabase(TODO_DATA_FILE);
